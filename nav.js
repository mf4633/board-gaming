...
(function () {
  ...
  // BEGIN GAMES — generated by scripts/generate-catalog.js
    ...
    { slug:'Wordform', name:'Wordform', cat:'puzzles', desc:'Daily 5-letter word puzzle', keys:['word','wordle','letter','daily','vocabulary'], daily:true },
    { slug:'Drift', name:'Drift', cat:'puzzles', desc:'Daily word ladder — original', keys:['word','ladder','daily','vocabulary','original'], daily:true },
    { slug:'Sudoku', name:'Sudoku', cat:'puzzles', desc:'Place 1–9, easy to expert', keys:['logic','number','grid','classic'], daily:true },
...
`;
  ...
  function buildRail(cur) {
    ...
    pickRelated(cur, 6).forEach(g => {
      const a = elt('a', { href:'/' + g.slug + '.html' });
    ...
    more.appendChild(elt('a', { href:'/play.html' }, 'full catalog →'));
